...
**YOU ARE IN: `hello_world/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/hello_world/` (rig root) or other directories
...
**Your mail address:** `hello_world/polecats/obsidian`
**Your rig:** hello_world
**Your Witness:** `hello_world/witness`
...
| Ask Witness for help | `gt mail send hello_world/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`hello_world/witness`) when:
...
```bash
gt mail send hello_world/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
